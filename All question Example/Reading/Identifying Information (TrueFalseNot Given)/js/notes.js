...
function Note(options) {
    ...
    if (!options || options.highlightText) {
        ...
        highlight.setAttribute('contenteditable', true);
        highlight.addEventListener('keyup', function() {
            return self.onKeyUp();
        }, false);
...
Note.prototype = {
    ...
    set hText(x) {
        ...
        //this.highlightField.innerHTML = x;
