...
var qti = (function($) {
    ...
    (function() {
        ...
        qti.scriptsLoading = $.Deferred();
        qti.mappingScriptLoad = $.Deferred();
        ...
        function init() {
            ...
            qti.mappingScriptLoad.promise().done(function() {
        ...
        /* try {
        	requirejs('jquery');
        	qti.scriptsLoading.promise().done(init);
        } catch (e) { */
        qti.mappingScriptLoad.resolve(); // UA 14/04/2016: Cambridge English not yet using app.js and settings.js
        window.onload = init;
        //}
                ...
                if (svgTexts.length === 0) {
                    ...
                    svgTexts.each(function(i) {
                        ...
                        qti.polledCheck(function() {
                            ...
                            if (intrxnId) {
                                tei = svgCtnr.find('span[connect\\:class~="inlineInteraction"]:has([connect\\:responseIdentifier]), [connect\\:identifier]').eq(intrxnId - 1);
                            } else {
                                intrxnId = svgTextElm.attr('responseIdentifier') || svgTextElm.attr('id');
                                tei = svgCtnr.find('span[connect\\:class~="inlineInteraction"]:has([connect\\:responseIdentifier="' + intrxnId + '"]), [connect\\:identifier="' + intrxnId + '"]');
                            }
        ...
        var applyContentScrolling = function(contentElm, enable) {
            ...
            resizeMain = qti.resizeMain = function() {
                ...
                if (currentItem.length > 0) {
                    ...
                    currentItem = mainContent.find('>*[connect\\:class~="itemBody"]:first, >.nontest');
                }
                if (currentItem.length > 0) {
        ...
        (function() {
            ...
            var helpDialogue = (function() {
                ...
                helpDialogue.showDialogue = function(dialogueTitle, draggable) {
                    ...
                    if (draggable) {
                        //$('body > div.dialogue-wrapper:visible').draggable({handle: 'div.title'});
                    ...
                    /*			var dialogue = {};
                    			dialogue.showDialogue = function(dialogueTitle, type) {
                    				...
                    				if (dialogue.content) {
                    					...
                    					dialogue.content = qti.holdingPagesContent.find('[data-type="'+type+'"]').clone();
                    					qti.mainElement.append(dialogue.content);
        ...
        var setupItems = qti._setupItems = function() {
            ...
            var questionFocusHandler = qti.questionFocusHandler = function(event) {
                ...
                var intrcn = $(this),
                    ...
                    targetInteractions, index, subInts, ctnrSlctr, activeInteraction, focusTarget, leftHolder;
                if (!navref) {
                ...
                if (navref && itemref) {
                    ...
                    if (!targetInteractions.hasClass('inFocus')) {
                        ...
                        $('em[connect\\:author-class~="highlight"]')
                            ...
                            .addClass('inFocus');
                        //fix for CCBT-32 - separateStimulus
                        qti.activeItem.find('div.separateStimulus *[data-interaction-identifier]').eq(index).addClass('inFocus');
                        activeInteraction = qti.activeItem.find('em[connect\\:author-class~="' + targetInteractions.find('[connect\\:responseIdentifier]').attr('connect:responseIdentifier') + '"]');
                        if (activeInteraction.length) {
                            leftHolder = activeInteraction.closest('[connect\\:author-class="left"]');
                            leftHolder.scrollTop(activeInteraction.offset().top - leftHolder.offset().top);
                        }
                    }
                }
            };
                                ...
                                var $stimulusCtnr = $(this),
                                    ...
                                    loadContent = function(url, dataType) {
                                        return $.get(url, function(content) {
                                            ...
                                            rsc_attribs[url].content = content;
                                        }, dataType);
                                    };
                                if (url) {
                                    idfr = url;
            ...
            setupExtendedTextRTE = function(itemInteraction, textInteraction) {
                var proxyTextareaElm = textInteraction.clone(),
                    ...
                    settings = {
                        ...
                        content_css: "js/maths-entry/maths-edit.rte.css, css/item.css",
                                ...
                                if (isDragItem.test(draggedItem.attr("connect:class"))) {
                                    ...
                                    if (dropItem.css("min-width") !== "0px") {
                                        ...
                                        if (dragOffset > dropOffset) {
                                            dropItem.css("margin-left", (dropOffset - dragOffset) * 1.7 + "px"); // 1.7 is a fudge factor that seems to work.
                                        } else {
    ...
    (function() {
        ...
        var loadItemFunc = function(itemBody) {
                ...
                setupInteractionSet = function(inlineChoiceInteractions, inlineChoicesContainer) {
                    ...
                    inlineChoiceInteractions.each(function(index, inlineChoiceInteraction) {
                        ...
                        if (inHorizontalWidgetContainer || inlineChoiceInteraction.is('[nav~="inlineChoiceGroup"]')) {
                            ...
                            if (qti.preloadTestContents) {
                                qti.screens[itemIdentifier].init.push(function() {
                                    setupCustonDrpDwnWidget(inlineChoiceInteraction, responseVariable);
                                });
                            }
                        }
                    });
            ...
            function setupCustonDrpDwnWidget(inlineChoiceInteraction, responseVariable) {
                var parentHolderHeightLoad, parentHolderHeightChange,
                    ...
                    totalWidth,
                    responseRef = inlineChoiceInteraction.attr('connect:responseIdentifier'),
                    inlineChoiceDL = $('<dl id="' + responseRef + '-list" class="inlineChoice customDrpDwnStyle"></dl>');
                ...
                function checkListPosition(currentList) {
                    if (currentList.is(":visible")) {
                        ...
                        parentHolderHeightChange = $('div[connect\\:author-class="left"]:visible')[0].scrollHeight;
                 ...
                 */
                $("dt", inlineChoiceDL).click(function(event) {
                    parentHolderHeightLoad = $('div[connect\\:author-class="left"]:visible')[0].scrollHeight;
                    event.preventDefault();
                    itemBody.find("dl.inlineChoice dd ul").not(optionsList).hide();
