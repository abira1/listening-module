...
var theme = (function($) {
    ...
    (function() {
        ...
        function preloadMainAudio() {
            if (qti.audioPlayer) {
                $('#audio-control').show();
                qti.audioPlayer.$mainAudio = $('#main-audio-content');
                if (qti.audioPlayer.$mainAudio.length) {
                    qti.audioPlayer.jPlayer("setMedia", {
                        oga: qti.audioPlayer.$mainAudio.val()
                    });
                }
        ...
        function prepareTestScreen() {
            ...
            qti._onResize();
            if (qti.audioPlayer) {
                if (qti.audioPlayer.$mainAudio.length === 0) {
                    qti.audioPlayer.jPlayer("setMedia", {
                        oga: qti.activeItem.find('audio:first').attr("src")
                    });
                }
