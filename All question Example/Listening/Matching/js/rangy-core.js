    ...
    I.addShimListener = function(e) {
        ...
        function h(e, t, n) {
            ...
            if (r.deleteData(0, t), e.deleteData(t, e.length - t), l(r, e), n)
                for (var i, a = 0; i = n[a++];) i.node == e && i.offset > t ? (i.node = r, i.offset -= t) : i.node == e.parentNode && i.offset > o(e) && ++i.offset;
            return r
        }
        ...
        function x(n, r) {
            ...
            d.prototype = e.rangePrototype, n.prototype = new d, H.extend(n.prototype, {
                ...
                normalizeBoundaries: function() {
                    ...
                    var e, t = this.startContainer,
                        ...
                        s = function(e) {
                            ...
                            if (r && r.nodeType == e.nodeType) {
                                t = e;
                                var a = e.length;
                                if (n = r.length, e.insertData(0, r.data), X(r), t == o) i += n, o = t;
                        ...
                        c = !0;
                    if (L(o)) i == o.length ? a(o) : 0 == i && (e = o.previousSibling, e && e.nodeType == o.nodeType && (i = e.length, t == o && (c = !1), e.appendData(o.data), X(o), o = e));
                    else {
                        if (i > 0) {
                    ...
                    if (c) {
                        if (L(t)) 0 == n ? s(t) : n == t.length && (e = t.nextSibling, e && e.nodeType == t.nodeType && (o == e && (o = t, i += t.length), t.appendData(e.data), X(e)));
        ...
        H.extend(e.rangePrototype, {
            compareBoundaryPoints: function(e, t) {
                ...
                var n, r, o, i, a = e == lt || e == dt ? "start" : "end",
            ...
            moveToBookmark: function(e) {
                ...
                for (var r, o, i, a, s = [t], c = !1, d = !1; !d && (r = s.pop());)
                    if (3 == r.nodeType) o = n + r.length, !c && e.start >= n && e.start <= o && (this.setStart(r, e.start - n), c = !0), c && e.end >= n && e.end <= o && (this.setEnd(r, e.end - n), d = !0), n = o;
                    else
                        for (a = r.childNodes, i = a.length; i--;) s.push(a[i])
            },
            getName: function() {
                return "DomRange"
            },
        ...
        function C(e, t) {
            for (var n, r, o = tt.length; o--;)
                ...
                else if (n.win == e) return "delete" == t ? (tt.splice(o, 1), !0) : r;
        ...
        function y(e) {
            ...
            if ("undefined" != typeof e.rangeCount)
                for (var i = 0, a = e.rangeCount; a > i; ++i) t[i] = b.inspect(e.getRangeAt(i));
            ...
            rt.removeAllRanges = function() {
                try {
                    if (this.docSelection.empty(), "None" != this.docSelection.type) {
                        var e;
                        if (this.anchorNode) e = k(this.anchorNode);
        ...
        rt.refresh = function(e) {
            ...
            if (it(this), e) {
                ...
                for (; o--;)
                    if (!W(t[o], this._ranges[o])) return !0;
                return !1
            }
        };
        var at = function(e, t) {
