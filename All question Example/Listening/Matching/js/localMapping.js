...
var mapping = (function($) {
    ...
    (function() {
        ...
        function showPreTestScreens(xml) {
            ...
            function moveToNextScreen() {
                ...
                if (contentArr[screenNumber]) {
                    ...
                    if (screenType === "access" && !qti.hasAccessAPI) {
                        screenNumber += 1;
        ...
        function pauseTimer() {
            qti.timerPause();
            if (qti.audioPlayer && $('#main-audio-content').length > 0) {
        ...
        function showPauseHoldingPage() {
            ...
            if (qti.preloadTestContents) {
                if (content.find('[data-type="paused"]').length === 0) {
                    content.find('>:not([connect\\:class~="itemBody"])').remove();
        ...
        function hideTools() {
            ...
            $('div.note').hide();
            $('div.dialogue-overlay').hide();
            $('div.dialogue-wrapper').hide();
