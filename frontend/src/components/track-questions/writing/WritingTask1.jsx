 ...
 * Academic writing task - describe visual information
 */
...
export function WritingTask1({ question, onAnswer, onReview }) {
  const [answer, setAnswer] = useState('');
  const [isReview, setIsReview] = useState(false);
  const [wordCount, setWordCount] = useState(0);

  const minWords = question.minWords || 150;
  const maxWords = question.maxWords || 250;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 p-4 rounded-lg">
        <h3 className="text-lg font-semibold text-gray-800 mb-2">Writing Task 1</h3>
