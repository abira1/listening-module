...
export function WritingTest({ examId }) {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-gray-50">
      ...
      <main className="flex-1 flex pb-[70px]" style={{ paddingTop: isHeaderHidden ? '80px' : '136px' }} id="highlightable-content">
      ...
      >
        ...
        <div className="relative h-full">
          ...
          >
                  ...
                  return (
                    ...
                    >
                      <a
                        ...
                        style={isNavMaximised ? { fontSize: '16px', width: '2em', height: '2em', lineHeight: '2em' } : {}}
                      >
            ...
            <div className="views" style={{ bottom: '16px', right: '95px' }}>
              <a
                href="#"
                className="minimise"
                onClick={(e) => {
                ...
                style={{ width: '22px', height: '22px', backgroundSize: 'contain' }}
              >
